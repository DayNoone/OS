...
public class BarbershopGui extends JFrame implements Constants, Gui, ChangeListener {
	...
	private void loadImages() {
		...
		wallsImage = loadImage(tk, "src/P2/images/walls.gif", tracker);
		floorImage = loadImage(tk, "src/P2/images/floor.gif", tracker);
		loungeChairImage = loadImage(tk, "src/P2/images/loungechair.gif", tracker);
		barberChairImage = loadImage(tk, "src/P2/images/barberchair.gif", tracker);
		barberImage = loadImage(tk, "src/P2/images/barber.gif", tracker);
		customerImages = new Image[NOF_CUSTOMER_LOOKS];
		for(int i = 0; i < NOF_CUSTOMER_LOOKS; i++) {
			customerImages[i] = loadImage(tk, "src/P2/images/customer"+i+".gif", tracker);
		}
		tableImage = loadImage(tk, "src/P2/images/table.gif", tracker);
		deskImage = loadImage(tk, "src/P2/images/desk.gif", tracker);
		sleepImage = loadImage(tk, "src/P2/images/sleep.gif", tracker);
		try {
			tracker.waitForID(0);
